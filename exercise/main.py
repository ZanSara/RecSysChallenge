...
parser.add_argument('--prediction_file', type=str, default="output/predictions.csv")
...
logger.info('Quality evaluation started')
tic = dt.now()
...
for test_user in range(nusers):
    ...
    if len(relevant_items) > 0:
        ...
        # "NOT IMPORTANT" METRICS COMMENTED OUT
...
#mrr_ /= n_eval
#ndcg_ /= n_eval
logger.info('Quality evaluated in {}'.format(dt.now()-tic))
