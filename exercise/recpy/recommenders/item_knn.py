...
from .similarity import KNNCosine, Cosine, Pearson, AdjustedCosine


class ItemKNNRecommender(Recommender):
    """ ItemKNN recommender"""

    def __init__(self, k=50, shrinkage=100, similarity='KNNcosine', normalize=False):
        ...
        if similarity == 'KNNcosine':
            self.similarity = KNNCosine(shrinkage=self.shrinkage)
    ...
    def fit(self, X):
        self.dataset = X
        # this method return a table already capped to the K most similar items
